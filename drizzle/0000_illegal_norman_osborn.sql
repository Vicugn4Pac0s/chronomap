...
CREATE TABLE `template_t3app_post` (
...
CREATE INDEX `created_by_idx` ON `template_t3app_post` (`created_by`);--> statement-breakpoint
CREATE INDEX `name_idx` ON `template_t3app_post` (`name`);--> statement-breakpoint
CREATE INDEX `session_userId_idx` ON `template_t3app_session` (`userId`);